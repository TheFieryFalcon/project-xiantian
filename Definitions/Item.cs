...
class Item(int Id, string Name, string Description, Rarity Rarity = Rarity.MORTAL, bool HasWeight = false, int Weight = 1, bool Sellable = false, int SellPrice = 0, Currency SellCurrency = Currency.COINS, int BuyPrice = 0, Currency BuyCurrency = Currency.COINS, bool Buyable = false) {
